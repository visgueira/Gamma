...
def main():
    ...
    st.info("Por favor, selecione um arquivo para carregar. O botão acima mudará de cor quando você selecionar um arquivo.", icon="ℹ️")

    with st.sidebar:
        uploaded_file = st.file_uploader("Envie o arquivo quotedata.csv", type="csv", help="Selecione um arquivo para carregar.")
